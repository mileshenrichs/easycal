  ...
  render() {
    return (
      <div className="OnboardingMessage">
        ...
        below.  It'd be a good idea to <Link to="/me">set up your goals</Link> first, then come back to this screen by clicking the "Today's Log" button in the navigation bar.</p>
      </div>
    );
  }
}
